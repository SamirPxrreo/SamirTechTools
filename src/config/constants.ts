...
export const OFFICE = {
  ...
  // Office 2016 Professional Plus 32-bit — descarga directa via GitHub Releases
  OFFICE_2016: {
    name: 'Office 2016 Professional Plus (32-bit)',
    url: 'https://github.com/SamirPxrreo/AionUi-Downloads/releases/download/v2.1.44/Office_Professional_Plus_2016_32bits_Spanish.zip',
